...
import KnowledgeMemberForKnowledgeNoti from '../../../components/KnowledgeNotification/knowledgeMember';
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', backgroundColor: 'white' }}>
                        {
                            user_knowledge.length == 0 ?
                                ...
                                <FlatList
                                    ...
                                    data={user_knowledge}
                                    renderItem={({ item }) => (
                                        <KnowledgeMemberForKnowledgeNoti item={item} navigation={navigation} />
                                    )}
...
export default UserKnowledgeForKN;
