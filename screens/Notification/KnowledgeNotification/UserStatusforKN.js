...
import StatusMemberForKnowledgeNoti from "../../../components/KnowledgeNotification/statusMember";
...
const UserStatusForKN = ({ navigation, route }) => {
              ...
              renderItem={({ item }) => (
                <StatusMember
                  ...
                  nextScreen={[
                    ...
                    "Knowledge Notification Show React User",
                    "Knowledge Notification Comment",
                  ]}
                />
              )}
...
export default UserStatusForKN;
