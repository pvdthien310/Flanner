...
import CommentMemberForSNoti from '../../../components/StatusNotification/commentMember';
...
const CommentScreenForSNoti = ({ navigation, route }) => {
...

                    {
                        ...
                        <View>
                            ...
                            <FlatList style={{ padding: 10, height: height * 0.6 }}
                                ...
                                data={listComment}
                                renderItem={({ item }) => (
                                    <CommentMemberForSNoti item={item} navigation = {navigation} ></CommentMemberForSNoti>
                                )}
...
export default CommentScreenForSNoti;
