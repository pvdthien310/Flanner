...
import KnowledgeMemberForStatusNoti from '../../../components/StatusNotification/knowledgeMember';
...
const UserKnowledgeForSN = ({ navigation, route }) => {
                    ...
                    <View style={{ flex: 1, justifyContent: 'center', backgroundColor: 'white' }}>
                        {
                            user_knowledge.length == 0 ?
                                ...
                                <FlatList
                                    ...
                                    data={user_knowledge}
                                    renderItem={({ item }) => (
                                        <KnowledgeMemberForStatusNoti item={item} navigation={navigation} />
                                    )}
...
export default UserKnowledgeForSN;
