...
import StatusMemberForSearch from '../../components/Search/statusMember'
...
const UserStatusForSearch = ({ navigation,route }) => {
            ...
            </TouchableOpacity>
            {
                loading ? <ActivityIndicator size="small" color="#0000ff" />
                    ...
                    <FlatList
                        ...
                        data={user_status}
                        renderItem={({ item }) => (
                            <StatusMemberForSearch item={item} navigation={navigation} />
                        )}
...
export default UserStatusForSearch;
