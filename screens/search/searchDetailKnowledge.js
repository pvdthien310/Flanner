...
import { StyleSheet, Text, View, Image, FlatList, SafeAreaView, ActivityIndicator, Alert } from 'react-native';
import { PostText, UserInfoText } from '../../shared/post';
import { ScrollView, TouchableOpacity } from 'react-native-gesture-handler';
import { Poststyle_Status, Poststyle } from '../../styles/poststyle';
...
const SearchDetailKnowledge = ({ route, navigation }) => {
                ...
                loading ? <ActivityIndicator marginTop={80} size="small" color="#0000ff" />
                    ...
                    <SafeAreaView style={styles.post}>
                        ...
                        <ScrollView style={{ margin: 10, marginBottom: 60 }} showsVerticalScrollIndicator={false}>
                            ...
                            <TouchableOpacity onPress={() => navigation.push('Search Show React User', { data })} >
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-around', margin: 10 }}>
                                ...
                                <TouchableOpacity onPress={() => navigation.push('Search Comment', { item: data })}  >
...
export default SearchDetailKnowledge;
