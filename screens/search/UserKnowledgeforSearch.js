...
import KnowledgeMemberForSearch from '../../components/Search/knowledgeMember';
...
const UserKnowledgeForSearch = ({ navigation, route }) => {
                    ...
                    </TouchableOpacity>
            {
                loading ? <ActivityIndicator size="small" color="#0000ff" />
                    ...
                    <FlatList
                        ...
                        data={user_knowledge}
                        renderItem={({ item }) => (                      
                            <KnowledgeMemberForSearch item={item} navigation={navigation} />
                        )}
...
export default UserKnowledgeForSearch;
