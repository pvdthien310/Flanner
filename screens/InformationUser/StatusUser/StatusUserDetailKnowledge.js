...
const StatusUserDetailKnowledge = ({ route, navigation }) => {
                ...
                loading ? <ActivityIndicator size="small" color="#0000ff" />
                    ...
                    <SafeAreaView style={styles.post}>
                        ...
                        <ScrollView style={{ margin: 10, marginBottom: 60 }} showsVerticalScrollIndicator={false}>
                            ...
                            <TouchableOpacity onPress={() => navigation.push('Status User Info Show React User', { data })}>
...
export default StatusUserDetailKnowledge;
