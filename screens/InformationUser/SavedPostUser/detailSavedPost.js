...
const DetailSavedPost = ({ navigation, route }) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity style={{ width: 100,  borderRadius: 10 }} onPress={() => navigation.goBack()}>
                <View style={{ flexDirection: 'row', width: 80, alignItems: 'center', alignSelf: 'center', justifyContent: 'space-between' }}>
...
export default DetailSavedPost;
