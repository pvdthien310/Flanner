...
const CreateFessScreen = ({ navigation, route }) => {
  ...
  const createAlert = () =>
    Alert.alert("Note!", "You has been creator", [
      { text: "OK", onPress: () => console.log("OK Pressed") },
    ]);

  const createAlertSub = () =>
    Alert.alert("Note!", "Members count should be 3 mates or more", [
      { text: "OK", onPress: () => console.log("OK Pressed") },
    ]);

  const createOneButtonAlert = () =>
    Alert.alert("Limited!", "This one has already been a member", [
      { text: "OK", onPress: () => console.log("OK Pressed") },
    ]);
