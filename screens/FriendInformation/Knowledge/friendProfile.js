                    ...
                    <View style={{
                        ...
                        <View style={{ flexDirection: 'column', padding: 10}}>
                            ...
                            <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
                                <TouchableOpacity onPress={() => navigation.push('Knowledge Friend Knowledge', { user: friendInfo, knowledge: knowledge })} >
                                    <View style={styles.button1}>
                                        <Text style={{ color: 'white', fontSize: 15, paddingStart: 10, paddingEnd: 10, fontFamily: 'nunitobold' }}>Knowledge</Text>
                                    </View>
                                </TouchableOpacity>
                                <TouchableOpacity onPress={() => navigation.push('Knowledge Friend Status', { user: friendInfo, status: status })}  >
