...
const UserKnowledgeMember = ({ item, navigation, routes }) => {
  ...
  const DeleteKnowledge = () => {
    ...
    KnowLedgeApi.Delete({
      ...
      .then((res) => {
        ...
        dispatch({
          type: "DELETE_USER_KNOWLEDGE_MEMBER",
  ...
  return (
    <Post>
      <PostImage>
        ...
        >
          <Text style={{ ...Poststyle_Status.posttime, alignSelf: "center" }}>
            {item.posttime}
          </Text>
          <View
            style={{
      ...
      <PostText>
        <TouchableOpacity
          onPress={() => navigation.push(routes.detail, { item })}
        >
          <View
      ...
      >
        ...
        >
          <Image
            ...
            style={Poststyle_Status.imageavatar}
          />
