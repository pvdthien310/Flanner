...
const StatusMemberForKUser = ({ item, navigation }) => {
            ...
            <Post >
                ...
                <TouchableOpacity onPress={() => {
                    if (item.userID != user.userID) {
                        navigation.push(
                            'Knowledge User Info Friend Profile',
                            { item: [host] })
                ...
                <TouchableOpacity onPress={() => navigation.push('Knowledge User Info Show React User', { data: item })}>
                    <ReactNumber  >
...
export default react.memo(StatusMemberForKUser);