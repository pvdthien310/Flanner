...
const StatusMemberForStatusNoti = ({ item, navigation, nextScreen }) => {
  ...
  return (
    ...
    >
      <Post>
        ...
        <TouchableOpacity
          onPress={() => {
            if (item.userID != user.userID) {
              navigation.push("Status Notification Friend Profile", {
                item: [host],
              });
            } else {
        ...
        <TouchableOpacity
          onPress={() =>
            navigation.push("Status Notification Show React User", {
              data: item,
            })
          }
        >
        ...
        <InteractionWrapper style={Poststyle.interactionwrapper}>
          ...
          <TouchableOpacity
            onPress={() =>
              navigation.push("Status Notification Comment", { item: data })
            }
...
export default react.memo(StatusMemberForStatusNoti);
