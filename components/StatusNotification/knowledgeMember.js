...
const KnowledgeMemberForStatusNoti = ({ item, navigation }) => {
        ...
        <Post >
            <PostImage>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View>
                            <Image style={Poststyle.imagepost} source={{ uri: item.l }} />
            ...
            <PostText>
                ...
                onPress={() => navigation.push('Status Notification Detail Knowledge', { item })} >
...
export default react.memo(KnowledgeMemberForStatusNoti);